                ...
                <div id="full-slider-wrapper">
                    <div id="layerslider" style="width:100%;height:500px;">
                        <div class="ls-slide" data-ls="transition2d:1;timeshift:-1000;">
                            <img src="<?php echo base_url(); ?>assets/beetube/images/sliderimages/bg.png" class="ls-bg" alt="Slide background"/>
                            ...
                            <a href="<?php echo base_url(); ?>assets/beetube/#" class="ls-l button" style="border-radius:4px;text-align:center;left:63px; top:315px;background: #444;color: #ffffff;font-family: 'Open Sans';font-size: 14px;display: inline-block; text-transform: uppercase; font-weight: bold;" data-ls="durationout:850;offsetxin:90;offsetxout:-90;duration:4200;fadein:true;fadeout:true;">Buy This Theme</a>
                            <img class="ls-l" src="<?php echo base_url(); ?>assets/beetube/images/sliderimages/layer1.png" alt="layer 1" style="top:55px; left:700px;" data-ls="offsetxin:right;durationin:3000; delayin:600;durationout:850;rotatexin:-90;rotatexout:90;">
                        ...
                        <div class="ls-slide" data-ls="transition2d:1;timeshift:-1000;">
                            <img src="<?php echo base_url(); ?>assets/beetube/images/sliderimages/bg2.png" class="ls-bg" alt="Slide background"/>
                            ...
                            <a href="<?php echo base_url(); ?>assets/beetube/#" class="ls-l button" style="border-radius:4px;text-align:center;left:50%; top:315px;background: #444;color: #ffffff;font-family: 'Open Sans';font-size: 14px;display: inline-block; text-transform: uppercase; font-weight: bold;" data-ls="durationout:850;offsetxin:90;offsetxout:-90;duration:4200;fadein:true;fadeout:true;">Buy This Theme</a>
                            <img class="ls-l ls-linkto-1" style="top:400px;left:50%;white-space: nowrap;" data-ls="offsetxin:-50;delayin:1000;rotatein:-40;offsetxout:-50;rotateout:-40;" src="<?php echo base_url(); ?>assets/beetube/images/sliderimages/left.png" alt="">
                            <img class="ls-l ls-linkto-1" style="top:400px;left:52%;white-space: nowrap;" data-ls="offsetxin:50;delayin:1000;offsetxout:50;" src="<?php echo base_url(); ?>assets/beetube/images/sliderimages/right.png" alt="">
                        </div>
                    </div>
                </div>
            </section><!--end slider-->
                        ...
                        <div id="owl-demo-cat" class="owl-carousel carousel" data-car-length="6" data-items="6" data-loop="true" data-nav="false" data-autoplay="true" data-autoplay-timeout="4000" data-auto-width="true" data-margin="10" data-dots="false">
                            <div class="item-cat item thumb-border">
                                <figure class="premium-img">
                                    <img src="<?php echo base_url(); ?>assets/beetube/images/category/category1.png" alt="carousel">
                                    <a href="<?php echo base_url(); ?>assets/beetube/categories.html" class="hover-posts">
                                        <span><i class="fa fa-search"></i></span>
                                    </a>
                                </figure>
                                <h6><a href="<?php echo base_url(); ?>assets/beetube/categories.html">Entertainment</a></h6>
                            </div>
                            <div class="item-cat item thumb-border">
                                <figure class="premium-img">
                                    <img src="<?php echo base_url(); ?>assets/beetube/images/category/category2.png" alt="carousel">
                                    <a href="<?php echo base_url(); ?>assets/beetube/categories.html" class="hover-posts">
                                        <span><i class="fa fa-search"></i></span>
                                    </a>
                                </figure>
                                <h6><a href="<?php echo base_url(); ?>assets/beetube/categories.html">Technology</a></h6>
                            </div>
                            <div class="item-cat item thumb-border">
                                <figure class="premium-img">
                                    <img src="<?php echo base_url(); ?>assets/beetube/images/category/category3.png" alt="carousel">
                                    <a href="<?php echo base_url(); ?>assets/beetube/categories.html" class="hover-posts">
                                        <span><i class="fa fa-search"></i></span>
                                    </a>
                                </figure>
                                <h6><a href="<?php echo base_url(); ?>assets/beetube/categories.html">Fashion &amp; Beauty</a></h6>
                            </div>
                            <div class="item-cat item thumb-border">
                                <figure class="premium-img">
                                    <img src="<?php echo base_url(); ?>assets/beetube/images/category/category4.png" alt="carousel">
                                    <a href="<?php echo base_url(); ?>assets/beetube/categories.html" class="hover-posts">
                                        <span><i class="fa fa-search"></i></span>
                                    </a>
                                </figure>
                                <h6><a href="<?php echo base_url(); ?>assets/beetube/categories.html">Sports</a></h6>
                            </div>
                            <div class="item-cat item thumb-border">
                                <figure class="premium-img">
                                    <img src="<?php echo base_url(); ?>assets/beetube/images/category/category5.png" alt="carousel">
                                    <a href="<?php echo base_url(); ?>assets/beetube/categories.html" class="hover-posts">
                                        <span><i class="fa fa-search"></i></span>
                                    </a>
                                </figure>
                                <h6><a href="<?php echo base_url(); ?>assets/beetube/categories.html">Foods &amp; Drinks</a></h6>
                            </div>
                            <div class="item-cat item thumb-border">
                                <figure class="premium-img">
                                    <img src="<?php echo base_url(); ?>assets/beetube/images/category/category6.png" alt="carousel">
                                    <a href="<?php echo base_url(); ?>assets/beetube/categories.html" class="hover-posts">
                                        <span><i class="fa fa-search"></i></span>
                                    </a>
                                </figure>
                                <h6><a href="<?php echo base_url(); ?>assets/beetube/categories.html">Automotive</a></h6>
                            </div>
                            <div class="item-cat item thumb-border">
                                <figure class="premium-img">
                                    <img src="<?php echo base_url(); ?>assets/beetube/images/category/category4.png" alt="carousel">
                ...
                <div class="row secBg">
                    <div class="large-12 columns">
                            ...
                            <div class="tab-container tab-content active" data-content="1">
                                <div class="row list-group">
                                    ...
                                    <div class="item large-3 medium-6 columns group-item-grid-default">
                                        <div class="post thumb-border">
                                            <div class="post-thumb">
                                                <img src="<?php echo base_url(); ?>assets/beetube/images/video-thumbnail/3.jpg" alt="new video">
                                                <a href="<?php echo base_url(); ?>assets/beetube/single-video-v2.html" class="hover-posts">
                                                    <span><i class="fa fa-play"></i>Watch Video</span>
                                                </a>
                                                <div class="video-stats clearfix">
                                    ...
                                    <div class="item large-3 medium-6 columns group-item-grid-default">
                                        <div class="post thumb-border">
                                            <div class="post-thumb">
                                                <img src="<?php echo base_url(); ?>assets/beetube/images/video-thumbnail/5.jpg" alt="new video">
                                                <a href="<?php echo base_url(); ?>assets/beetube/single-video-v2.html" class="hover-posts">
                                                    <span><i class="fa fa-play"></i>Watch Video</span>
                                                </a>
                                                <div class="video-stats clearfix">
                                    ...
                                    <div class="item large-3 medium-6 columns group-item-grid-default">
                                        <div class="post thumb-border">
                                            <div class="post-thumb">
                                                <img src="<?php echo base_url(); ?>assets/beetube/images/video-thumbnail/7.jpg" alt="new video">
                                                <a href="<?php echo base_url(); ?>assets/beetube/single-video-v2.html" class="hover-posts">
                                                    <span><i class="fa fa-play"></i>Watch Video</span>
                                                </a>
                                                <div class="video-stats clearfix">
                        ...
                        <div class="text-center row-btn">
                            <a class="button radius" href="<?php echo base_url(); ?>assets/beetube/all-video.html">View All Video</a>
                        </div>
                    </div>
                </div>
            </section>
