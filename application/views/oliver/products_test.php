    ...
    <div class="row">
        ...
        <div class="col-md-8">
            ...
            <div class="col-md-12 no-padding">
                <h2 class="section-title"><span>Sub Categories</span></h2>
            </div>
            <div class="col-md-12 no-padding">
                <ul id="myTab" class="nav nav-tabs">
                    <?php $c = 1; ?>
                    <?php foreach ($sub_category as $print): ?>
                        <li class="<?php if ($c==1){echo 'active'; $c++;}else{echo '';}?>"><a href="<?php echo '#tab' . $print['id']; ?>" data-toggle="tab"><?php echo $print['subname']; ?></a></li>
                    <?php endforeach; ?>
                </ul>
                <div id="myTabContent" class="tab-content">
                    <div class="tab-pane fade active in clearfix media " id="tab1">
                        <?php foreach ($products as $product): ?>
                            <?php if($product['categories']['subcategory'] == "1"){ ?>
                            <div class="row tabcus1">
                                <img class="pull-left imgcus1" src="<?php echo base_url(); ?>assets/tfl1/images/products/team-member-1s.png" alt=""/>
                                <h4 class="headcus1"><?php echo $product['name']; ?></h4>
                                <p><?php echo substr('Lorem ipsum dolor slo onsec designs tueraliquet Morbi nec In Curabitur lreaoreet nislsus lorem in pellente e vidicus pannel impirus sadintas. Lorem ipsum dolor slo onsec  designs tueraliquet Morbi nec In Curabitur lreaoreet', 0, 200);?></p>
                            </div>
                            <?php } ?>
                        <?php endforeach; ?>
                    </div>
                    <div class="tab-pane fade clearfix media " id="tab2">
                        <?php foreach ($products as $product): ?>
                            <?php if($product['categories']['subcategory'] == "2"){ ?>
                            <div class="row tabcus1">
                                <img class="pull-left imgcus1" src="<?php echo base_url(); ?>assets/tfl1/images/products/team-member-1s.png" alt=""/>
                                <h4 class="headcus1"><?php echo $product['name']; ?></h4>
                                <p><?php echo substr('Lorem ipsum dolor slo onsec designs tueraliquet Morbi nec In Curabitur lreaoreet nislsus lorem in pellente e vidicus pannel impirus sadintas. Lorem ipsum dolor slo onsec  designs tueraliquet Morbi nec In Curabitur lreaoreet', 0, 200);?></p>
                    ...
                    <div class="tab-pane fade clearfix media " id="tab3">
                        <?php foreach ($products as $product): ?>
                            <?php if($product['categories']['subcategory'] == "3"){ ?>
                            <div class="row tabcus1">
                                <img class="pull-left imgcus1" src="<?php echo base_url(); ?>assets/tfl1/images/products/team-member-1s.png" alt=""/>
                                <h4 class="headcus1"><?php echo $product['name']; ?></h4>
                                <p><?php echo substr('Lorem ipsum dolor slo onsec designs tueraliquet Morbi nec In Curabitur lreaoreet nislsus lorem in pellente e vidicus pannel impirus sadintas. Lorem ipsum dolor slo onsec  designs tueraliquet Morbi nec In Curabitur lreaoreet', 0, 200);?></p>
                    ...
                    <div class="tab-pane fade clearfix media " id="tab4">
                        <?php foreach ($products as $product): ?>
                            <?php if($product['categories']['subcategory'] == "4"){ ?>
                            <div class="row tabcus1">
                                <img class="pull-left imgcus1" src="<?php echo base_url(); ?>assets/tfl1/images/products/team-member-1s.png" alt=""/>
                                <h4 class="headcus1"><?php echo $product['name']; ?></h4>
                                <p><?php echo substr('Lorem ipsum dolor slo onsec designs tueraliquet Morbi nec In Curabitur lreaoreet nislsus lorem in pellente e vidicus pannel impirus sadintas. Lorem ipsum dolor slo onsec  designs tueraliquet Morbi nec In Curabitur lreaoreet', 0, 200);?></p>
                    ...
                    <div class="tab-pane fade clearfix media " id="tab5">
                        <?php foreach ($products as $product): ?>
                            <?php if($product['categories']['subcategory'] == "5"){ ?>
                            <div class="row tabcus1">
                                <img class="pull-left imgcus1" src="<?php echo base_url(); ?>assets/tfl1/images/products/team-member-1s.png" alt=""/>
                                <h4 class="headcus1"><?php echo $product['name']; ?></h4>
                                <p><?php echo substr('Lorem ipsum dolor slo onsec designs tueraliquet Morbi nec In Curabitur lreaoreet nislsus lorem in pellente e vidicus pannel impirus sadintas. Lorem ipsum dolor slo onsec  designs tueraliquet Morbi nec In Curabitur lreaoreet', 0, 200);?></p>
