            ...
            <article class="post col-md-12">
                <div class="post-thumb">
                    <div id="post-slider" class="flexslider">
                        <ul class="slides">
                            <li><img src="<?php echo base_url() . $industry_intro['imageurl1']; ?>" alt=""/></li>
                        </ul>
                    </div> 
                ...
                <div class="post-info">
                    <h3><a href=""><?php echo $industry_intro['industryname']; ?></a></h3>
                    <p><?php echo $industry_intro['industryinfo']; ?></p>
                </div>
