<!-- wrapper -->
	<div id="wrapper">	
		<section class="bg-primary">
			<div class="container">
				<h3 class="color-white font-weight-300">Checkout as a Guest</h3>
			</div>
		</section>
			...
			<div class="tab-select sticky">
				<div class="container">
					<ul class="nav nav-tabs" role="tablist">
						<li><a href="<?php echo base_url(); ?>games/login">Login</a></li>
				...
				<div class="row">
					...
					<div class="panel panel-default">
							<div class="panel-body">
								...
								<div class="headline">
									<h4 class="no-padding-top">Guest Checkout <small>Continue as a Guest ...</small></h4>
								...
								<div class="col-lg-6 col-md-6 col-sm-6">
									<div class="panel-body" style="margin-left: 25px;">	
	                                    <div class="row-form">
	                                        <div class="span12" style="font-weight: 500; margin: 0 0 10px 0;"><?php echo 'Area:';?></div>
